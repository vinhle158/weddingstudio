...
import { MessageSquare, Send, Hash, User as UserIcon, Shield, Search, Sparkles } from 'lucide-react';
...
export default function Chat({ userId, userRole }: ChatProps) {
  ...
  return (
    <div className="max-w-6xl mx-auto h-[calc(100vh-140px)] flex flex-col md:flex-row bg-white rounded-2xl shadow-2xs border border-gold-200/30 overflow-hidden" id="chat-system">
      
      {/* Sidebar - Contacts & Channels */}
      <div className="w-full md:w-80 border-r border-slate-200 flex flex-col bg-slate-50/50" id="chat-sidebar">
        {/* Header */}
      ...
      {/* Main Chat Area */}
      <div className="flex-grow flex flex-col bg-slate-50/20" id="chat-main-area">
        {/* Chat Area Header */}
